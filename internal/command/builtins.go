...
func Builtins() []Definition {
	return []Definition{
		...
		{Name: "agent", Description: "提交子 Agent 任务", Usage: "/agent defined|fork [options] <task>", Type: TypeUI, ArgHint: "defined|fork [options] <task>", Handler: taskIntentHandler},
		{Name: "tasks", Description: "显示子 Agent 任务列表", Usage: "/tasks", Type: TypeUI, Handler: taskIntentHandler},
		{Name: "task", Description: "查看或操作子 Agent 任务", Usage: "/task <task-id> [operation]", Type: TypeUI, ArgHint: "<task-id> [operation]", Handler: taskIntentHandler},
